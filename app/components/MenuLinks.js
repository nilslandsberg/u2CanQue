  ...
  return (
    <div className="bg-black text-white fixed top-0 left-0 right-0 z-30 pt-[90px]">
      <div className='text-2xl font-bold italic text-center py-2'>
          <p>"Ordering Tomorrow's Lunch Today"</p>
      </div>
      <nav className="text-lg font-semibold pb-2 flex flex-row justify-around text-center items-center border-b border-white ">
        ...
        <a href="/order/seasonal" className="hover:text-slate-300">Seasonal</a>
      </nav>
    </div>
  );
};
